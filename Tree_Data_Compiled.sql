...
(
SELECT tree_count_cte.zip_code, tree_count_cte.tree_count, borough, nta_name, i.Households_Median_Income, p."Population Total" as population_total, l.Number_of_blocks  
FROM tree_count_cte
JOIN Income i 
...
SELECT *, population_total/number_of_blocks as Humans_per_block, tree_count/number_of_blocks as trees_per_block, population_total/tree_count as humans_to_tree FROM cte_join;
